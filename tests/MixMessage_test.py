...
def test_get_data_fragment_with_padding():
    ...
    message_id, frag_id, _, payload = cut(fragment, FRAG_ID_SIZE, FRAG_FLAG_SIZE, expected_padding_size_length)
